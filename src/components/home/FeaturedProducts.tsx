...
const products = [
  {
    ...
    description: "[9.5×10 Inch, Pack of 50 VIP  Organic Disposable Plates | 100% Natural, Eco-Friendly Biodegradable Plates with QR CODE for Wedding, Events, Parties & Picnic Plate.",
